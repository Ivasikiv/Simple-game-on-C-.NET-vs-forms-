...
namespace Lab6 {
    public partial class FormPlanets : Form {
        ...
        { "HumuAnt", "..\\images\\HumuAntBackgraund.jpg"},
        { "Catalina", "..\\images\\CatalinaBackgraund.jpg" },
        { "Celestrix", "..\\images\\CelestrixBackgraund.jpg" },
        { "Elysium", "..\\images\\ElysiumBackgraund.jpg" },
        { "Astra", "..\\images\\AstraBackgraund.jpg" }
        };
        ...
        private void FormPlanets_Shown(object sender, EventArgs e) {
            switch (planetName) {
                case "HumuAnt":
                    FormPlanets.ActiveForm.BackgroundImage = System.Drawing.Image.FromFile("..\\images\\HumuAntBackground.jpg");
                    break;
                case "Catalina":
                    if (currentPlanet.WeatherDebuffs["Power"] > 0 || currentPlanet.WeatherDebuffs["Protection"] > 0) {
                        FormPlanets.ActiveForm.BackgroundImage = System.Drawing.Image.FromFile("..\\images\\CatalinaBackgroundSpecial.jpg");
                    } else {
                        FormPlanets.ActiveForm.BackgroundImage = System.Drawing.Image.FromFile("..\\images\\CatalinaBackground.jpg");
                    }
                ...
                case "Celestrix":
                    if (currentPlanet.WeatherDebuffs["Power"] > 0 || currentPlanet.WeatherDebuffs["Protection"] > 0) {
                        FormPlanets.ActiveForm.BackgroundImage = System.Drawing.Image.FromFile("..\\images\\CelestrixBackgroundSpecial.jpg");
                    } else {
                        FormPlanets.ActiveForm.BackgroundImage = System.Drawing.Image.FromFile("..\\images\\CelestrixBackground.jpg");
                    }
                    ...
                    break;
                case "Elysium":
                    FormPlanets.ActiveForm.BackgroundImage = System.Drawing.Image.FromFile("..\\images\\ElysiumBackground.jpg");
                    break;
                case "Astra":
                    if (currentPlanet.WeatherDebuffs["Power"] > 0 || currentPlanet.WeatherDebuffs["Protection"] > 0) {
                        FormPlanets.ActiveForm.BackgroundImage = System.Drawing.Image.FromFile("..\\images\\AstraBackgroundSpecial.jpg");
                    } else {
                        FormPlanets.ActiveForm.BackgroundImage = System.Drawing.Image.FromFile("..\\images\\AstraBackground.jpg");
                    }
            ...
            playerPicture.Image = System.Drawing.Image.FromFile("..\\images\\player.png");
        ...
        // Метод для отримання відповідної стратегії руху залежно від типу монстра
        private MonsterMovement GetMovementStrategy(string monsterType) {
            switch (monsterType) {
                case "Fast Pirate":
                    return new FastPirateMovement();
                case "Protected Pirate":
                    return new ProtectedPirateMovement();
                case "Strong Pirate":
                    return new StrongPirateMovement();
                default:
                    throw new ArgumentException("Unsupported monster type: " + monsterType);
            }
        }
        ...
        private void timer1_Tick(object sender, EventArgs e) {
            ...
            foreach (var monster in battle.monsters) {
                ...
                MonsterMovement movementStrategy = GetMovementStrategy(currentPlanet.pirates[index].Type);

                int newX = monster.x;
                int newY = monster.y;

                positionsIterators[currentPlanet.pirates[index].Type] = 
                    movementStrategy.UpdateMovement(monster.pictureBox, ref newX, ref newY, positionsIterators[currentPlanet.pirates[index].Type]);
                // перевірка чи newX і newY не виходять за межі форми
                if (newX < this.ClientSize.Width / 2 || newX > this.ClientSize.Width - monster.pictureBox.Width || newY < 0 || newY > this.ClientSize.Height - monster.pictureBox.Height) {
                    newX = monster.x;
                    
                }
                monsterUpdates.Add((monster.pictureBox, monster.speed, newX, newY));
            }
        ...
        private void FormPlanets_KeyDown(object sender, KeyEventArgs e) {
            switch (e.KeyCode) {
                ...
                case Keys.Space:
                    ...
                    IObserver observer = SpaceShip.Instance.shipPower.GetFirstObserver();
                    PowerObserver powerObserver = observer as PowerObserver;

                    int laserWidth = 50;
                    int laserHeight = 50;

                    if (powerObserver.GetColor() == "green") {
                        laserWidth = 70;
                        laserHeight = 70;
                    } else if (powerObserver.GetColor() == "yellow") {
                        laserWidth = 90;
                        laserHeight = 90;
                    }
                    ...
                    if (powerObserver.GetColor() == "red") {
                        laser.Image = System.Drawing.Image.FromFile("..\\images\\laserRed.png");
                    } else if (powerObserver.GetColor() == "green") {
                        laser.Image = System.Drawing.Image.FromFile("..\\images\\laserGreen.png");
                    } else if (powerObserver.GetColor() == "yellow") {
                        laser.Image = System.Drawing.Image.FromFile("..\\images\\laserYellow.png");
                    }
                    ...
                    for (int j = 0; j < battle.monsters.Count(); j++) {
                        ...
                        if (monster != null && laser.Bounds.IntersectsWith(monster.Bounds)) {
                            ...
                            if (battle.pirateGroup.CurrentTarget != null) {
                                ...
                                monster.Image = System.Drawing.Image.FromFile(((Pirate)battle.pirateGroup.GetEnemy(j)).imagePath);
                                if (!isAlive) {
                                    battle.monsters.RemoveAt(j);
                                    this.Controls.Remove(monster);
