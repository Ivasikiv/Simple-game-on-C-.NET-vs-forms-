    ...
    public partial class FormTrader : Form {
        ...
        private void buttonUpgradePower_Click(object sender, EventArgs e) {
            ...
            if (!MainForm.RemoveCoins(price)) {
                ...
                labelUpgradePower.Text = "Power lvl: " + mainForm.GetSpaceShip().shipPower.ToString();
        ...
        private void buttonUpgradeProtection_Click(object sender, EventArgs e) {
            if (mainForm.upgrades["Protection"] == 9) {
            ...
            if (!MainForm.RemoveCoins(price)) {
                ...
                labelUpgradeProtection.Text = "Protection lvl: " + mainForm.GetSpaceShip().shipProtection.ToString();
                labelCoins.Text = MainForm.coins.ToString();
        ...
        private void buttonUpgradeCritHit_Click(object sender, EventArgs e) {
            ...
            if (!MainForm.RemoveCoins(price)) {
                ...
                labelUpgradeCritHit.Text = "Critical hit: " + mainForm.GetSpaceShip().shipCriticalHitProbability.ToString() + "%";
                labelCoins.Text = MainForm.coins.ToString();
        ...
        private void FormTrader_Shown(object sender, EventArgs e) {
            ...
            mainForm.upgrades["Power"] = (int)mainForm.GetSpaceShip().shipPower;
            mainForm.upgrades["Protection"] = (int)mainForm.GetSpaceShip().shipProtection;
            mainForm.upgrades["Crit"] = (int)mainForm.GetSpaceShip().shipCriticalHitProbability;
        }
        ...
        private void buttonSellArtifacts_Click(object sender, EventArgs e) {
            ...
            MainForm.coins += amountOfArtifactsToSell * value;
