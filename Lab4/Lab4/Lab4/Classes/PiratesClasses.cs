    ...
    */
    ...
    class FastPirate : Pirate {
        public FastPirate() {
            ...
            imagePath = "D:\\Jesus\\MAPZ Labs\\mapz\\Lab4\\Lab4\\Lab4\\images\\yellow-alien.png";
        }
    ...
    class ProtectedPirate : Pirate {
        public ProtectedPirate() {
            ...
            HealthPoints = new Random().Next(1, 10);
            Damage = new Random().Next(1, 10);
            imagePath = "D:\\Jesus\\MAPZ Labs\\mapz\\Lab4\\Lab4\\Lab4\\images\\red-alien.png";
        }
        public override void Attack() {
    ...
    class StrongPirate : Pirate {
        public StrongPirate() {
            ...
            HealthPoints = new Random().Next(1, 10);
            Damage = new Random().Next(1, 10);
            imagePath = "D:\\Jesus\\MAPZ Labs\\mapz\\Lab4\\Lab4\\Lab4\\images\\gray-alien.png";
        }
