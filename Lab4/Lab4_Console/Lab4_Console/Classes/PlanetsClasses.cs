...
namespace Lab4.Classes {
    ...
    містить поля, такі як Name, GoldReward, Artefacts, WeatherDebuffs, які не 
    ...
    з властивостями, такими як Name, GoldReward, Artefacts, WeatherDebuffs, без 
    ...
    */
    ...
    public abstract class PlanetShape {
        ...
        public virtual void PopulatePirates() {
    ...
    public class ColonialPlanet : PlanetShape {
        ...
        public override void PopulatePirates() {
            pirates.Clear();
